                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(fontWeight: FontWeight.bold,fontFamily: "AssistantLight", color: ConstColors.bgColor, fontSize: 30),
                    ),
                    Text(
                      "$description ",
                      textAlign: TextAlign.center,

                      style: TextStyle(fontWeight: FontWeight.bold,fontFamily: "SourceSansProExtra", color: ConstColors.txtFormFieldColor, fontSize: 20),
                    )
                  ],
                ),
              ),
